...
<div class="quote-box popupTrigger" data-popup-id="HGWells_quote">
  <div class="quote-text">“Statistical thinking will one day be as necessary for efficient citizenship as the ability to read and write.”</div>
  <div class="quote-author">— H. G. Wells</div>
  </div>

## Machine Learning
My research using machine learning is mainly focused on geoscience and on how to use ML frameworks in unconventional contexts.
...
## Research philosophy
I put particular importance on investigating cutting‑edge solutions, from both technological and algorithmic perspectives. Most applications of these solutions are done through collaborations.
